...
data class HighSchool(
    ...
    //
    // If at some point the app needs one of these properties do the following:
    //
    // 1. Uncomment the corresponding line
    // 2. move that line into the list above
    // 3. add @SerializedName
